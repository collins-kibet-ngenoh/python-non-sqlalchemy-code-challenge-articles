...
# my_mag = Magazine("The Herald", "Sports")
# my_author = Author("collins kibet")
# my_article = Article(my_author, my_mag, "Effects of Sports")

# # #my_mag.articles()
# Magazine.top_publisher()

# your_mag = Magazine("New York Times", "Politics")
# your_author = Author("collins kibet")
# your_article = Article(your_author, your_mag, "Effects of Sports")

# #print(mag.name for mag in your_mag.contributors())
# # your_author.topic_areas()
# your_mag.contributing_authors()

# # print(my_article.title, my_article.author.name)
# my_author.articles()
# your_author.articles()
